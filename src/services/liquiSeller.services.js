...
class liquiSeller {
	...
	static async invoiceLiquidated(data) {
		try {
			const result = await models.bills_liquidation_sellers.bulkCreate(
				data
			);
			return result;
		} catch (error) {
	...
	static async invoiceLiquidatedDeleteID(id) {
		try {
			const result = await models.bills_liquidation_sellers.destroy({
	...
	static async delete(id) {
		try {
			const result = await models.liquidation_sellers.destroy({
				where: { id },
			});
			return result;
		} catch (error) {
	...
	static async update(id, data) {
		try {
			const result = await models.liquidation_sellers.update(data, {
				where: { id },
			});
			return result;
		} catch (error) {
