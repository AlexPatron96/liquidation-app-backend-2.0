...
class liquidationVeh {
	...
	static async invoiceLiquidatedDeleteID(id) {
		try {
			const result = await models.bills_liquidation_veh.destroy({
	...
	static async delete(id) {
		try {
			const result = await models.liquidation_veh.destroy({
				where: { id },
			});
			return result;
		} catch (error) {
	...
	static async update(id, data) {
		try {
			const result = await models.liquidation_veh.update(data, {
				where: { id },
			});
			return result;
		} catch (error) {
