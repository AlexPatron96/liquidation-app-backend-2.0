...
function initModels(sequelize) {
  ...
  balance_sell.hasMany(cuadre_balance_seller, { as: "cuadre_balance_sellers", foreignKey: "id_balance" });

  cuadre_balance_veh.belongsTo(balance_veh, { as: "id_balance_balance_veh", foreignKey: "id_balance" });
  balance_veh.hasMany(cuadre_balance_veh, { as: "cuadre_balance_vehs", foreignKey: "id_balance" });
 ...
 //Verificar---------------
  ...
  cash_sell.belongsTo(liquidation_sellers, { as: "liquidation_seller", foreignKey: "settlement_code" });
  liquidation_sellers.hasMany(cash_sell, { as: "cash_sell", foreignKey: "settlement_code" });

  discounts_sell.belongsTo(liquidation_sellers, { as: "liquidation_seller", foreignKey: "settlement_code" });
  liquidation_sellers.hasMany(discounts_sell, { as: "discounts_sell", foreignKey: "settlement_code" });

  expense_sell.belongsTo(liquidation_sellers, { as: "liquidation_seller", foreignKey: "settlement_code" });
...
//Verificar---------------
  ...
  delivered_credits.belongsTo(liquidation_veh, { as: "liquidation_veh", foreignKey: "settlement_code" });
  liquidation_veh.hasMany(delivered_credits, { as: "delivered_credits", foreignKey: "settlement_code" });

  discounts_veh.belongsTo(liquidation_veh, { as: "liquidation_veh", foreignKey: "settlement_code" });
  liquidation_veh.hasOne(discounts_veh, { as: "discounts_veh", foreignKey: "settlement_code" });

  expense_veh.belongsTo(liquidation_veh, { as: "liquidation_veh", foreignKey: "settlement_code" });
  liquidation_veh.hasOne(expense_veh, { as: "expense_veh", foreignKey: "settlement_code" });
  ...
  pre_liquidations.hasMany(bills_pre, { as: "bills_pres", foreignKey: "id_pre_liquidation" });
  ...
  sellers.hasMany(delivered_credits, { as: "delivered_credits", foreignKey: "id_seller" });

  liquidation_sellers.belongsTo(sellers, { as: "seller", foreignKey: "id_seller" });
  sellers.hasMany(liquidation_sellers, { as: "liquidation_sellers", foreignKey: "id_seller" });

  pre_liquidations.belongsTo(sellers, { as: "id_seller_seller", foreignKey: "id_seller" });
  sellers.hasMany(pre_liquidations, { as: "pre_liquidations", foreignKey: "id_seller" });
  ...
  users.hasMany(liquidation_sellers, { as: "liquidation_sellers", foreignKey: "id_user" });

  liquidation_veh.belongsTo(users, { as: "user", foreignKey: "id_user" });
  users.hasMany(liquidation_veh, { as: "liquidation_vehs", foreignKey: "id_user" });
  ...
  liquidation_veh.belongsTo(vehicles, { as: "vehicle", foreignKey: "id_vehicle" });
  vehicles.hasMany(liquidation_veh, { as: "liquidation_vehs", foreignKey: "id_vehicle" });
